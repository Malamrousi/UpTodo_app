      ...
      builder: (context, state) {
        ...
        if (state is TaskSuccess) {
          if (state.notCompletedTasks.isEmpty) {
            return const Center(child: Text('No tasks to do'));
          }else{
                return Expanded(
            flex: 1,
            child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  var task =
                      context.read<TaskCubit>().notCompletedTasksList[index];

                  final taskCategory = context
                      .read<TaskCubit>()
                      .notCompletedTasksList[index]
                      .category;
